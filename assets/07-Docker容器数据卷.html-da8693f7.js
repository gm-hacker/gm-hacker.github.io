import{_ as n}from"./plugin-vue_export-helper-c27b6911.js";import{o as s,c as a,e}from"./app-405c8987.js";const t={},i=e(`<h1 id="docker容器数据卷" tabindex="-1"><a class="header-anchor" href="#docker容器数据卷" aria-hidden="true">#</a> Docker容器数据卷</h1><h2 id="_1-坑-容器卷记得加入" tabindex="-1"><a class="header-anchor" href="#_1-坑-容器卷记得加入" aria-hidden="true">#</a> 1 坑：容器卷记得加入</h2><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>--privileged=true
