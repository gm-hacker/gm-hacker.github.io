...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><ul><li><p><strong>支持 jdk1.8版本语法变更新特性</strong></p><p>Connector/J 8.0是专门为在Java 8平台上运行而创建的。</p><p>众所周知，Java8与早期的Java版本高度兼容，</p><p>但还是存在少量不兼容性，所以,驱动技术版本,尽量选择支持jdk 8.0+!</p></li><li><p><strong>支持全新的驱动api,增加自动时区选择和默认utf-8编码格式等配置</strong></p></li></ul><h2 id="三、全新jdbc核心api" tabindex="-1"><a class="header-anchor" href="#三、全新jdbc核心api" aria-hidden="true">#</a> 三、全新JDBC核心API</h2><h3 id="_3-1-引入mysql-jdbc驱动jar" tabindex="-1"><a class="header-anchor" href="#_3-1-引入mysql-jdbc驱动jar" aria-hidden="true">#</a> 3.1 引入mysql-jdbc驱动jar</h3><p>1、驱动jar版本选择</p><p>我们选择版本 8.0.27版本</p><table><thead><tr><th>mysql版本</th><th>推荐驱动版本</th><th>备注</th></tr></thead><tbody><tr><td>mysql 5.5.x</td><td>5.0.x</td><td>com.mysql.jdbc.Driver</td></tr><tr><td>mysql 5.7.x</td><td>5.1.x</td><td>com.mysql.jdbc.Driver</td></tr><tr><td>msyql 8.x</td><td>8.0.x</td><td><strong>建议: 8.0.25+省略时区设置</strong>com.mysql.cj.jdbc.Driver</td></tr></tbody></table><p>2、java工程导入依赖</p><p>a、<strong>项目创建lib文件夹</strong></p><p>b、<strong>导入驱动依赖jar包</strong></p><p>c、<strong>jar包右键-添加为项目依赖</strong></p><figure><img src="`+r+'" alt="img" tabindex="0" loading="lazy"><figcaption>img</figcaption></figure><h3 id="_3-2-jdbc基本使用步骤分析-6步" tabindex="-1"><a class="header-anchor" href="#_3-2-jdbc基本使用步骤分析-6步" aria-hidden="true">#</a> 3.2 jdbc基本使用步骤分析（6步）</h3><ol><li>注册驱动【依赖的jar包 进行安装】</li><li>获取连接【connection建立连接】</li><li>创建发送sql语句对象【statement 创建发送sql语句的statement】</li><li>发送sql语句，并获取返回结果【statement发送sql语句到数据库 并且取得返回结构】</li><li>结果集解析【将result结果解析出来】</li><li>资源关闭【释放resultset、statement、connection】</li></ol><figure><img src="'+k+`" alt="img" tabindex="0" loading="lazy"><figcaption>img</figcaption></figure><h3 id="_3-3-基于statement演示查询" tabindex="-1"><a class="header-anchor" href="#_3-3-基于statement演示查询" aria-hidden="true">#</a> 3.3 基于statement演示查询</h3><ul><li>准备数据库数据</li></ul><div class="language-SQL line-numbers-mode" data-ext="SQL"><pre class="language-SQL"><code>CREATE DATABASE atguigu;
...
INSERT INTO t_user(account,PASSWORD,nickname) VALUES
  (&#39;root&#39;,&#39;123456&#39;,&#39;经理&#39;),(&#39;admin&#39;,&#39;666666&#39;,&#39;管理员&#39;);
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,26),T=a(`<li><p>演示目标</p><p>模拟登录,控制台输入账号和密码,判断是否登陆成功成功!</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>root
123456
登陆成功！
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div></li>`,1),E=n("p",null,"类加载知识补充",-1),A={href:"http://t.csdnimg.cn/Hfe8X",target:"_blank",rel:"noopener noreferrer"},J=n("p",null,[s("类加载：就是将类的class文件读入内存，并创建一个"),n("code",null,"Java.lang.class"),s("对象。类在运行期第一次使用时，首先会被类加载器动态加载至JVM。类的加载过程又分为了五个阶段：加载、验证、准备、解析、初始化。为了方便记忆可以编为一个口诀：家(加载)宴(验证)准备(准备)了西(解析)式(初始化)菜。")],-1),O=n("p",null,"类的生命周期被分为了七个阶段：加载、验证、准备、解析、初始化、使用、限载",-1),B=n("li",null,[n("p",null,"基于statement实现模拟登录")],-1),M=a(`<div class="language-Java line-numbers-mode" data-ext="Java"><pre class="language-Java"><code>/**
 * @Author 赵伟风
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><figure><img src="`+v+`" alt="img" tabindex="0" loading="lazy"><figcaption>img</figcaption></figure><h3 id="_3-6-基于preparedstatement演示curd" tabindex="-1"><a class="header-anchor" href="#_3-6-基于preparedstatement演示curd" aria-hidden="true">#</a> 3.6 基于preparedStatement演示curd</h3><ul><li>数据库数据插入</li></ul><div class="language-java line-numbers-mode" data-ext="java"><pre class="language-java"><code><span class="token doc-comment comment">/**
 * 插入一条用户数据!
 * 账号: test
 * 密码: test
 * 昵称: 测试
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><ul><li><p>代码结构设计</p><figure><img src="`+m+`" alt="img" tabindex="0" loading="lazy"><figcaption>img</figcaption></figure></li><li><p>jdbc事务实现</p><ul><li>测试类</li></ul></li></ul><div class="language-java line-numbers-mode" data-ext="java"><pre class="language-java"><code><span class="token doc-comment comment">/**
 * @Author 赵伟风
 * Description: 测试类
 */</span>
...
- 直到池中的连接达到“最大连接数”，就不能在申请新的连接了，如果没有拿到连接的用户只能等待。
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_5-3-市面常见连接池产品和对比" tabindex="-1"><a class="header-anchor" href="#_5-3-市面常见连接池产品和对比" aria-hidden="true">#</a> 5.3 市面常见连接池产品和对比</h3><div class="language-Java line-numbers-mode" data-ext="Java"><pre class="language-Java"><code>JDBC 的数据库连接池使用 javax.sql.**DataSource**接口进行规范,**所有**的第三方**连接池**
    ...
    - Druid 是阿里提供的数据库连接池，据说是集DBCP 、C3P0 、Proxool 优点于一身
      的数据库连接池,**妥妥国货之光!!!!**
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><figure><img src="`+b+'" alt="img" tabindex="0" loading="lazy"><figcaption>img</figcaption></figure><figure><img src="'+g+`" alt="img" tabindex="0" loading="lazy"><figcaption>img</figcaption></figure><h3 id="_5-4-国货之光druid连接池使用" tabindex="-1"><a class="header-anchor" href="#_5-4-国货之光druid连接池使用" aria-hidden="true">#</a> 5.4 国货之光druid连接池使用</h3><blockquote><p>记得导入druid工具类jar</p></blockquote><ul><li>硬编码方式(了解,不推荐)</li></ul><div class="language-java line-numbers-mode" data-ext="java"><pre class="language-java"><code><span class="token doc-comment comment">/**
...
<span class="token keyword">public</span> <span class="token keyword">void</span> <span class="token function">druidHard</span><span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token keyword">throws</span> <span class="token class-name">SQLException</span> <span class="token punctuation">{</span>
   ...
   connection<span class="token punctuation">.</span><span class="token function">close</span><span class="token punctuation">(</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><ul><li><p>软编码方式</p><ul><li><p>外部配置</p><p>存放在<strong>src/druid.properties</strong></p></li></ul></li></ul><div class="language-properties line-numbers-mode" data-ext="properties"><pre class="language-properties"><code><span class="token comment"># druid连接池需要的配置参数,key固定命名</span>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><ul><li>druid配置(了解)</li></ul>`,54),Q=n("thead",null,[n("tr",null,[n("th",null,"配置"),n("th",null,"缺省"),n("th",null,"说明")])],-1),R=n("tr",null,[n("td",null,"name"),n("td"),n("td",null,"配置这个属性的意义在于，如果存在多个数据源，监控的时候可以通过名字来区分开来。 如果没有配置，将会生成一个名字，格式是：”DataSource-” + System.identityHashCode(this)")],-1),N=n("tr",null,[n("td",null,"jdbcUrl"),n("td"),n("td",null,"连接数据库的url，不同数据库不一样。例如：mysql : jdbc:mysql://10.20.153.104:3306/druid2 oracle : jdbc:oracle:thin:@10.20.149.85:1521:ocnauto")],-1),P=n("tr",null,[n("td",null,"username"),n("td"),n("td",null,"连接数据库的用户名")],-1),I=n("td",null,"password",-1),z=n("td",null,null,-1),U={href:"https://github.com/alibaba/druid/wiki/%E4%BD%BF%E7%94%A8ConfigFilter",target:"_blank",rel:"noopener noreferrer"},F=n("tr",null,[n("td",null,"driverClassName"),n("td"),n("td",null,"根据url自动识别 这一项可配可不配，如果不配置druid会根据url自动识别dbType，然后选择相应的driverClassName(建议配置下)")],-1),V=n("tr",null,[n("td",null,"initialSize"),n("td",null,"0"),n("td",null,"初始化时建立物理连接的个数。初始化发生在显示调用init方法，或者第一次getConnection时")],-1),K=n("tr",null,[n("td",null,"maxActive"),n("td",null,"8"),n("td",null,"最大连接池数量")],-1),H=n("tr",null,[n("td",null,"maxIdle"),n("td",null,"8"),n("td",null,"已经不再使用，配置了也没效果")],-1),Y=n("tr",null,[n("td",null,"minIdle"),n("td"),n("td",null,"最小连接池数量")],-1),W=n("tr",null,[n("td",null,"maxWait"),n("td"),n("td",null,"获取连接时最大等待时间，单位毫秒。配置了maxWait之后，缺省启用公平锁，并发效率会有所下降，如果需要可以通过配置useUnfairLock属性为true使用非公平锁。")],-1),G=n("tr",null,[n("td",null,"poolPreparedStatements"),n("td",null,"false"),n("td",null,"是否缓存preparedStatement，也就是PSCache。PSCache对支持游标的数据库性能提升巨大，比如说oracle。在mysql下建议关闭。")],-1),X=n("tr",null,[n("td",null,"maxOpenPreparedStatements"),n("td",null,"-1"),n("td",null,"要启用PSCache，必须配置大于0，当大于0时，poolPreparedStatements自动触发修改为true。在Druid中，不会存在Oracle下PSCache占用内存过多的问题，可以把这个数值配置大一些，比如说100")],-1),Z=n("tr",null,[n("td",null,"validationQuery"),n("td"),n("td",null,"用来检测连接是否有效的sql，要求是一个查询语句。如果validationQuery为null，testOnBorrow、testOnReturn、testWhileIdle都不会其作用。")],-1),$=n("tr",null,[n("td",null,"testOnBorrow"),n("td",null,"true"),n("td",null,"申请连接时执行validationQuery检测连接是否有效，做了这个配置会降低性能。")],-1),nn=n("tr",null,[n("td",null,"testOnReturn"),n("td",null,"false"),n("td",null,"归还连接时执行validationQuery检测连接是否有效，做了这个配置会降低性能")],-1),sn=n("tr",null,[n("td",null,"testWhileIdle"),n("td",null,"false"),n("td",null,"建议配置为true，不影响性能，并且保证安全性。申请连接的时候检测，如果空闲时间大于timeBetweenEvictionRunsMillis，执行validationQuery检测连接是否有效。")],-1),an=n("tr",null,[n("td",null,"timeBetweenEvictionRunsMillis"),n("td"),n("td",null,"有两个含义： 1)Destroy线程会检测连接的间隔时间2)testWhileIdle的判断依据，详细看testWhileIdle属性的说明")],-1),tn=n("tr",null,[n("td",null,"numTestsPerEvictionRun"),n("td"),n("td",null,"不再使用，一个DruidDataSource只支持一个EvictionRun")],-1),en=n("tr",null,[n("td",null,"minEvictableIdleTimeMillis"),n("td"),n("td")],-1),pn=n("tr",null,[n("td",null,"connectionInitSqls"),n("td"),n("td",null,"物理连接初始化的时候执行的sql")],-1),cn=n("tr",null,[n("td",null,"exceptionSorter"),n("td"),n("td",null,"根据dbType自动识别 当数据库抛出一些不可恢复的异常时，抛弃连接")],-1),on=n("tr",null,[n("td",null,"filters"),n("td"),n("td",null,"属性类型是字符串，通过别名的方式配置扩展插件，常用的插件有： 监控统计用的filter:stat日志用的filter:log4j防御sql注入的filter:wall")],-1),ln=n("tr",null,[n("td",null,"proxyFilters"),n("td"),n("td",null,"类型是List，如果同时配置了filters和proxyFilters，是组合关系，并非替换关系")],-1),un=a(`<h2 id="六、全新jdbc使用优化以及工具类封装" tabindex="-1"><a class="header-anchor" href="#六、全新jdbc使用优化以及工具类封装" aria-hidden="true">#</a> 六、全新JDBC使用优化以及工具类封装</h2><p>过程：1.注册驱动 2.获取连接 3.编写SQL语句 4.创建statement 5.占位符赋值 6.发送SQL语句 7.结果解析 8.回收资源</p><p>下面v1.0和v2.0针对128进行封装</p><p>BaseDao针对34567进行封装，进行增删改查</p><h3 id="_6-1-jdbc工具类封装v1-0" tabindex="-1"><a class="header-anchor" href="#_6-1-jdbc工具类封装v1-0" aria-hidden="true">#</a> 6.1 jdbc工具类封装v1.0</h3><blockquote><p>我们封装一个工具类,内部包含<strong>连接池对象</strong>,同时对外提供连接的方法和回收连接的方法!</p></blockquote><p>外部配置文件</p><p>位置: src/druid.properties</p><div class="language-properties line-numbers-mode" data-ext="properties"><pre class="language-properties"><code><span class="token comment"># druid连接池需要的配置参数,key固定命名</span>
<span class="token key attr-name">driverClassName</span><span class="token punctuation">=</span><span class="token value attr-value">com.mysql.cj.jdbc.Driver</span>
<span class="token key attr-name">username</span><span class="token punctuation">=</span><span class="token value attr-value">root</span>
<span class="token key attr-name">password</span><span class="token punctuation">=</span><span class="token value attr-value">root</span>
<span class="token key attr-name">url</span><span class="token punctuation">=</span><span class="token value attr-value">jdbc:mysql:///atguigu</span>
...
<span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">JDBCTools</span> <span class="token punctuation">{</span>
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>**注意: **<strong>修改转账业务,使用此工具类</strong></p><h3 id="_6-3-高级应用层封装basedao" tabindex="-1"><a class="header-anchor" href="#_6-3-高级应用层封装basedao" aria-hidden="true">#</a> 6.3 高级应用层封装BaseDao</h3><blockquote><p>基本上每一个数据表都应该有一个对应的DAO接口及其实现类，发现对所有表的操作（增、删、改、查）代码重复度很高，所以可以<strong>抽取公共代码</strong>，给这些DAO的实现类可以抽取一个公共的父类，我们称为BaseDao</p></blockquote><p>针对DQL查询和非DQL进行，分成两类</p><div class="language-java line-numbers-mode" data-ext="java"><pre class="language-java"><code><span class="token keyword">public</span> <span class="token keyword">abstract</span> <span class="token keyword">class</span> <span class="token class-name">BaseDao</span> <span class="token punctuation">{</span>
    <span class="token comment">/*
    通用的增、删、改的方法
    String sql：sql
...
<span class="token comment">//                String columnName = metaData.getColumnName(i);//获取第i列的字段名</span>
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="七、基于cms项目jdbc实战练习" tabindex="-1"><a class="header-anchor" href="#七、基于cms项目jdbc实战练习" aria-hidden="true">#</a> 七、基于CMS项目JDBC实战练习</h2><h3 id="_7-1-cms项目介绍和导入" tabindex="-1"><a class="header-anchor" href="#_7-1-cms项目介绍和导入" aria-hidden="true">#</a> 7.1 cms项目介绍和导入.</h3><ul><li><p><strong>项目介绍</strong></p><blockquote><p>利用JavaSE技术,进行控制台输出的客户管理系统! 主要功能让包含<strong>客户展示</strong>,<strong>客户删除</strong>,<strong>客户添加</strong>,<strong>客户修改</strong>,<strong>退出系统</strong>!</p></blockquote><p>添加客户</p><figure><img src="`+y+'" alt="img" tabindex="0" loading="lazy"><figcaption>img</figcaption></figure><p>修改客户</p><figure><img src="'+f+'" alt="img" tabindex="0" loading="lazy"><figcaption>img</figcaption></figure><p>展示客户列表</p><figure><img src="'+w+'" alt="img" tabindex="0" loading="lazy"><figcaption>img</figcaption></figure><p>删除客户</p><figure><img src="'+h+'" alt="img" tabindex="0" loading="lazy"><figcaption>img</figcaption></figure><p>退出系统</p><figure><img src="'+S+'" alt="img" tabindex="0" loading="lazy"><figcaption>img</figcaption></figure></li><li><p><strong>项目导入</strong></p><ol><li><p>打开项目</p><figure><img src="'+q+'" alt="img" tabindex="0" loading="lazy"><figcaption>img</figcaption></figure></li><li><p>配置jdk</p><figure><img src="'+j+'" alt="img" tabindex="0" loading="lazy"><figcaption>img</figcaption></figure><figure><img src="'+C+`" alt="img" tabindex="0" loading="lazy"><figcaption>img</figcaption></figure></li></ol></li></ul><h3 id="_7-2-基于cms项目添加数据库相关配置" tabindex="-1"><a class="header-anchor" href="#_7-2-基于cms项目添加数据库相关配置" aria-hidden="true">#</a> 7.2 基于cms项目添加数据库相关配置</h3><ul><li>准备数据库脚本</li></ul><div class="language-sql line-numbers-mode" data-ext="sql"><pre class="language-sql"><code><span class="token comment">-- 员工表</span>
...
<span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">CustomerDao</span> <span class="token keyword">extends</span> <span class="token class-name">BaseDao</span> <span class="token punctuation">{</span>
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,38);function dn(rn,kn){const t=c("ExternalLinkIcon");return o(),l("div",null,[x,n("p",null,[n("a",_,[s("https://dev.mysql.com/doc/connector-j/8.0/en/connector-j-whats-new.html"),e(t)])]),L,n("ul",null,[T,n("li",null,[E,n("p",null,[s("【Java类加载机制 - CSDN App】"),n("a",A,[s("http://t.csdnimg.cn/Hfe8X"),e(t)])]),J,O]),B]),M,n("table",null,[Q,n("tbody",null,[R,N,P,n("tr",null,[I,z,n("td",null,[s("连接数据库的密码。如果你不希望密码直接写在配置文件中，可以使用ConfigFilter。详细看这里："),n("a",U,[s("https://github.com/alibaba/druid/wiki/%E4%BD%BF%E7%94%A8ConfigFilter"),e(t)])])]),F,V,K,H,Y,W,G,X,Z,$,nn,sn,an,tn,en,pn,cn,on,ln])]),un])}const bn=p(D,[["render",dn],["__file","05-JDBC.html.vue"]]);export{bn as default};
