...
![image-20231123103938928](image/image-20231123103938928.png)
...
```sql
mysql> SELECT CONCAT(worker.last_name ,' works for '
    -> , manager.last_name)
...
![image-20231123104313887](image/image-20231123104313887.png)
...
![img](image/1657863635749-493cc3c3-4ed4-427e-b98e-35f098afde34.png)

UNION 操作符返回两个查询的结果集的并集，去除重复记录。

**UNION ALL操作符** 

![img](image/1657863651765-15b7cc16-0bd9-4c74-88c9-9a1f9fb9bf0a.png)
...
![img](image/1657863744768-b7feabca-102e-4e90-9c25-3538ebab75c2.png)
