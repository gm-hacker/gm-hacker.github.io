...
| ------ | ------------------------------------------------------------ | ---------------------------------------------------- | ---------- |
| FLOAT  | (-3.402823466E+38，-1.175494351E-38)，0，(1.175494351E-38，3.402823466351E+38) | 0，(1.175494351E-38,3.402823466 E+38)                | 4          |
...
- 以 YYYY-MM-DD 格式或者 **YYMMDD** 格式表示的字符串日期，此格式中，年份为两位数值或字符串满足YEAR类型的格式条件为：当年份取值为00到69时，会被转化为2000到2069；当年份取值为70到99时，会被转化为1970到1999。
...
| 2023-11-29 03:51:59 | 2023-11-29 03:51:59 |
+---------------------+---------------------+
2 rows in set (0.00 sec)
...
| d1                  | d2                  |
+---------------------+---------------------+
| 2021-09-02 14:45:52 | 2021-09-02 22:45:52 |
| 2023-11-29 03:51:59 | 2023-11-29 11:51:59 |
+---------------------+---------------------+
2 rows in set (0.00 sec)
```
...
```sql
mysql> SELECT js -> '$.name' AS NAME,js -> '$.age' AS age ,
...
![image-20231129134806551](image/image-20231129134806551.png)

下面展示的是多个同类或异类几何图形元素的组合： 

![image-20231129134755802](image/image-20231129134755802.png)
