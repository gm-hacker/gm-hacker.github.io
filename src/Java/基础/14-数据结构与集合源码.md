...
![第3阶段：Java高级应用-第14章](image/第3阶段：Java高级应用-第14章.png)

## 1. 数据结构剖析

我们举一个形象的例子来理解数据结构的作用：

![image-20220412011531879](image/image-20220412011531879.png)
...
![image-20220412011555025](image/image-20220412011555025.png)

上图：没有战术，打仗事倍功半

![image-20220412011600845](image/image-20220412011600845.png)
...
![image-20220824011022664](image/image-20220824011022664.png)
...
![image-20220521100746910](image/image-20220521100746910.png)
...
![image-20220521103734742](image/image-20220521103734742.png)
...
![image-20220521115200921](image/image-20220521115200921.png)
...
![image-20220521115734571](image/image-20220521115734571.png)
...
![1563432676234](image/1563432676234.png)

例如：对象数组

![1563432696340](image/1563432696340.png)
...
![image-20220511113744772](image/image-20220511113744772-1661445988505.png)

- 常见的链表结构有如下的形式：


![1563448858180](image/1563448858180-1661445988506.png)

![数据结构-链表](image/数据结构-链表.png)

### 3.2 自定义链表

#### 3.2.1 自定义单向链表

![image-20221028195106363](image/image-20221028195106363.png)
...
![image-20220514165707977](image/image-20220514165707977-1661448081075.png)
...
![image-20221028192349993](image/image-20221028192349993.png)
...
![image-20220826010258638](image/image-20220826010258638.png)

![数据结构-栈](image/数据结构-栈.png)
...
![image-20220826010241172](image/image-20220826010241172.png)

![数据结构-队列](image/数据结构-队列.png)

## 6. 树与二叉树

### 6.1 树的理解

![image-20220521111904272](image/image-20220521111904272.png)
...
![1563449427345](image/1563449427345-1661447692846.png)
...
![1574575739236-1661447692846](image/1574575739236-1661447692846.png)
...
![image-20220521153016348](image/image-20220521153016348.png)

1、`满二叉树`： 除最后一层无任何子节点外，每一层上的所有结点都有两个子结点的二叉树。 第n层的结点数是2的n-1次方，总的结点个数是2的n次方-1

![1574575163883](image/1574575163883-1661447692846.png)

2、`完全二叉树`： 叶结点只能出现在最底层的两层，且最底层叶结点均处于次底层叶结点的左侧。

![1574575180247](image/1574575180247-1661447692846.png)
...
![image-20220521145208018](image/image-20220521145208018.png)
...
![image-20220521150151219](image/image-20220521150151219.png)
...
![image-20221208212053079](image/image-20221208212053079.png)
...
![1563549818689](image/1563549818689-1661447917313.png)
...
![image-20221029112037297](image/image-20221029112037297.png)

- **ArrayList自动扩容过程**

![image-20221029112107691](image/image-20221029112107691.png)

- **ArrayList的add(E e)方法**

![image-20221029112129161](image/image-20221029112129161.png)

- **ArrayList的add(int index,E e)方法**

![image-20221029112157007](image/image-20221029112157007.png)
...
![image-20221029134437888](image/image-20221029134437888.png)

- **包含4个元素的LinkedList**

![image-20221029134534198](image/image-20221029134534198.png)

- **add(E e)方法**

![image-20221029135013377](image/image-20221029135013377.png)

- **add(int index,E e)方法**

![image-20221029135045120](image/image-20221029135045120.png)

- **remove(Object obj)方法**

![image-20221029134721089](image/image-20221029134721089.png)

- **remove(int index)方法**

![image-20221029134807613](image/image-20221029134807613.png)
...
![image-20221029144811305](image/image-20221029144811305.png)
...
![image-20220514190849626](image/image-20220514190849626-1661448231966.png)
...
![image-20220514190904009](image/image-20220514190904009-1661448231966.png)
...
![image-20220524142524796](image/image-20220524142524796-1661448231966.png)
...
![image-20221029145708224](image/image-20221029145708224.png)
...
![1563797150134](image/1563797150134-1661448231965.png)
...
![image-20220514190454633](image/image-20220514190454633-1661448231965.png)
...
![1563800372286](image/1563800372286-1661448231966.png)
...
![1563802656661](image/1563802656661-1661448231966.png)

JDK1.8之后使用：数组+链表/红黑树的结构。

![1563802665708](image/1563802665708-1661448231966.png)
...
![HashMap的循环引用问题](image/HashMap的循环引用问题.jpg)
