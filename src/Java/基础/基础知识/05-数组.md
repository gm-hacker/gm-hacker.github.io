...
![第1阶段：Java基本语法-第05章](image/第1阶段：Java基本语法-第05章.png)
...
![snipaste_20220317_000101](image/snipaste_20220317_000101.jpg)
...
![image-20220317000952499](image/image-20220317000952499.png)
...
![image-20211221164709624](image/image-20211221164709624.png)
...
![image-20220317004637748](image/image-20220317004637748.png)
...
![image-20220317004810263](image/image-20220317004810263.png)
...
![image-20220516095701345](image/image-20220516095701345.png)

蓝框的几个元素，可以使用一维数组来存储。但现在发现每个元素下还有下拉框，其内部还有元素，那就需要使用二维数组来存储：

![image-20220516095829526](image/image-20220516095829526.png)

- 使用说明

![1561524724397](image/1561524724397-1647707344971.png)
...
![1562112672215](image/1562112672215.png)
...
![1562113179785](image/1562113179785.png)
...
![1562113981079](image/1562113981079.png)
...
![image-20220317005436209](image/image-20220317005436209.png)
...
![image-20220317005549522](image/image-20220317005549522.png)
...
![1574577970893](image/1574577970893.png)
...
![snipaste_20220317_225346](image/snipaste_20220317_225346.jpg)
...
![1659199523932](image/1659199523932.png)
...
![image-20221117195931777](image/image-20221117195931777.png)
...
![1561469087319](image/1561469087319.png)
...
![image-20220317230955644](image/image-20220317230955644.png)

实现步骤：

![image-20220623210601915](image/image-20220623210601915.png)
...
![image-20211222113701365](image/image-20211222113701365.png)
...
![image-20211222111142684](image/image-20211222111142684.png)
...
![image-20220824003440106](image/image-20220824003440106.png)

#### 6.6.3 冒泡排序（Bubble Sort）

![image-20220516094637228](image/image-20220516094637228.png)
...
![image-20220317235922776](image/image-20220317235922776.png)

图示2：

第一轮操作：

![image-20221117205612230](image/image-20221117205612230.png)

第二轮操作：

![image-20221117205719427](image/image-20221117205719427.png)
...
![](image/空指针异常-1647708157677.jpg)

**空指针异常在内存图中的表现**

![1572338767825](image/1572338767825-1647708157678.png)
