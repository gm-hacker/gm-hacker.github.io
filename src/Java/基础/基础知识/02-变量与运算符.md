...
![第1阶段：Java基本语法-第02章](image/第1阶段：Java基本语法-第02章.png)
...
![image-20220310234414849](image/image-20220310234414849.png)
...
![image-20220310234557454](image/image-20220310234557454.png)

![image-20220801143635356](image/image-20220801143635356.png)
...
![image-20220513235020527](image/image-20220513235020527.png)

一花一世界，如果把一个程序看做一个世界或一个社会的话，那么变量就是程序世界的花花草草、万事万物。即，**变量是程序中不可或缺的组成单位，最基本的存储单元**。

![image-20220513235828042](image/image-20220513235828042.png)
...
![image-20220311000744867](image/image-20220311000744867.png)
...
![image-20220514152216148](image/image-20220514152216148.png)
...
![image-20220520111756274](image/image-20220520111756274.png)

- Java各整数类型有固定的表数范围和字段长度，不受具体操作系统的影响，以保证Java程序的可移植性。

![image-20220311001553945](image/image-20220311001553945.png)
...
![image-20220311001749699](image/image-20220311001749699.png)
...
![image-20220523162200891](image/image-20220523162200891.png)

基本数据类型的转换规则如图所示：

![image-20220311002543688](image/image-20220311002543688.png)
...
![image-20220523162407722](image/image-20220523162407722.png)
...
![image-20220520105721126](image/image-20220520105721126.png)

记忆技巧：

![morsecode](image/morsecode.jpg)

我们偶尔会看到的：SOS，即为：

![image-20220520110206899](image/image-20220520110206899.png)
...
![image-20220523114701881](image/image-20220523114701881.png)
...
![image-20220312000042595](image/image-20220312000042595.png)

### 6.6 二进制与八进制、十六进制间的转换

**二进制转八进制**

![image-20220312000233863](image/image-20220312000233863.png)

**二进制转十六进制**

![image-20220312000251113](image/image-20220312000251113.png)

**八进制、十六进制转二进制**

![image-20220312000341297](image/image-20220312000341297.png)

### 6.7 各进制间的转换

![image-20220312000143438](image/image-20220312000143438.png)
...
![image-20220312000848332](image/image-20220312000848332.png)
...
![image-20220312001742263](image/image-20220312001742263.png)
...
![image-20220312001943403](image/image-20220312001943403.png)
...
![image-20220313174721111](image/image-20220313174721111.png)

![image-20220312002506339](image/image-20220312002506339.png)
...
![image-20200225113651675](image/image-20200225113651675.png)

```java
-3<<4  类似于  -3*2的4次幂 => -3*16 => -48
```

![image-20200225114707524](image/image-20200225114707524.png)
...
![image-20200225115636844](image/image-20200225115636844.png)

```
-69>>4  类似于  -69/2的4次 = -69/16 = -5
```

![image-20200225120112188](image/image-20200225120112188.png)
...
![image-20200225121104734](image/image-20200225121104734.png)

```
-69>>>4   结果：268435451
```

![image-20200225121244290](image/image-20200225121244290.png)
...
![image-20200225122440953](image/image-20200225122440953.png)

```java
-9 & 7 = 7
```

![image-20200225122221616](image/image-20200225122221616.png)
...
![image-20200225122758851](image/image-20200225122758851.png)

```java
-9 | 7 //结果： -9
```

![image-20200225123409130](image/image-20200225123409130.png)
...
![image-20200225123445305](image/image-20200225123445305.png)

```java
-9 ^ 7 //结果为-16
```

![image-20200225133145727](image/image-20200225133145727.png)
...
![image-20200225124112662](image/image-20200225124112662.png)

```java
~-9  //结果：8
```

![image-20200225124156862](image/image-20200225124156862.png)

#### 7.5.2 举例

**举例1：**

![snipaste_20220312_002549](image/snipaste_20220312_002549.jpg)

**举例2：体会 m = k ^ n = (m ^ n) ^ n**

![image-20220312002736157](image/image-20220312002736157.png)
...
![image-20220312002841945](image/image-20220312002841945.png)
...
![image-20220513095907601](image/image-20220513095907601.png)
