...
![第3阶段：Java高级应用-第17章](image/第3阶段：Java高级应用-第17章.png)
...
![image-20220417161529285](image/image-20220417161529285.png)

**从内存加载上看反射：**

![image-20220524101448625](image/image-20220524101448625.png)
...
![image-20220417162559217](image/image-20220417162559217.png)
...
![image-20220514180100176](image/image-20220514180100176.png)
...
![image-20220417173459849](image/image-20220417173459849.png)

### 3.2 类的加载过程

当程序主动使用某个类时，如果该类还未被加载到内存中，系统会通过加载、链接、初始化三个步骤来对该类进行初始化。如果没有意外，JVM将会连续完成这三个步骤，所以有时也把这三个步骤统称为类加载。

![image-20220417171411631](image/image-20220417171411631.png)
...
![image-20220417173647473](image/image-20220417173647473.png)
...
![image-20220417173616344](image/image-20220417173616344.png)
...
![image-20220417173819953](image/image-20220417173819953.png)
...
![image-20220417174032702](image/image-20220417174032702.png)
...
![image-20220417181700813](image/image-20220417181700813.png)
