...
![第2阶段：Java面向对象编程-第07章](image/第2阶段：Java面向对象编程-第07章.png)
...
![image-20220503102947013](image/image-20220503102947013.png)
...
![image-20220808191154534](image/image-20220808191154534.png)

**练习2：**

（1）按照如下的UML类图，创建相应的类，提供必要的结构：

![image-20220323211412409](image/image-20220323211412409.png)

在提款方法withdraw()中，需要判断用户余额是否能够满足提款数额的要求，如果不能，应给出提示。deposit()方法表示存款。

（2）按照如下的UML类图，创建相应的类，提供必要的结构

![image-20220323211454372](image/image-20220323211454372.png)

（3）按照如下的UML类图，创建相应的类，提供必要的结构

![image-20220323211521808](image/image-20220323211521808.png)
...
![image-20220323211653907](image/image-20220323211653907.png)
...
![image-20220323215921441](image/image-20220323215921441.png)

- 绿化：前人栽树，后人乘凉

![image-20220520171727778](image/image-20220520171727778.png)

“绿水青山，就是金山银山”

* 样貌：

![image-20220323220246746](image/image-20220323220246746.png)

* 继承之外，是不是还可以"`进化`"：

![image-20220323220537644](image/image-20220323220537644.png)
...
![image-20220323220923386](image/image-20220323220923386.png)

为描述和处理**学生**信息，定义类Student：

![image-20220323221001495](image/image-20220323221001495.png)

通过继承，简化Student类的定义：

![image-20220323221050791](image/image-20220323221050791.png)
...
![猫狗继承2](image/猫狗继承2.jpg)

再举例：

![image-20220323221436571](image/image-20220323221436571.png)
...
![image-20211230090255997](image/image-20211230090255997.png)

**2、子类不能直接访问父类中私有的(private)的成员变量和方法**

子类虽会继承父类私有(private)的成员变量，但子类不能对继承的私有成员变量直接进行访问，可通过继承的get/set方法进行访问。如图所示：

![image-20220323224757212](image/image-20220323224757212.png)
...
![image-20220323225441417](image/image-20220323225441417.png)
...
![image-20220514162507692](image/image-20220514162507692.png)

![image-20220523201405061](image/image-20220523201405061.png)
...
![image-20220323231804928](image/image-20220323231804928.png)
...
![image-20220323231942361](image/image-20220323231942361.png)
...
![image-20211230093627763](image/image-20211230093627763.png)

（2）外部类的权限修饰符如果缺省，跨包使用有问题

![image-20211230094236974](image/image-20211230094236974.png)

**2、成员的权限修饰符问题**

（1）本包下使用：成员的权限修饰符可以是public、protected、缺省

![image-20211230095320646](image/image-20211230095320646.png)

（2）跨包下使用：要求严格

![image-20211230095817784](image/image-20211230095817784.png)

（3）跨包使用时，如果类的权限修饰符缺省，成员权限修饰符>类的权限修饰符也没有意义

![image-20211230100219840](image/image-20211230100219840.png)
...
![image-20211230110411580](image/image-20211230110411580.png)
...
![image-20200227141228450](image/image-20200227141228450.png)
...
![image-20200303183542807](image/image-20200303183542807.png)
...
![image-20220324003430464](image/image-20220324003430464.png)
...
![image-20220324003447242](image/image-20220324003447242.png)
...
![image-20220324003616767](image/image-20220324003616767.png)

## 6. 子类对象实例化全过程

![image-20220324003713230](image/image-20220324003713230.png)

```java
Dog dog = new Dog("小花","小红");
```

![image-20220324003735416](image/image-20220324003735416.png)

![image-20220324003813163](image/image-20220324003813163.png)
...
![image-20220324234208997](image/image-20220324234208997.png)

前提：Person类中定义了welcome()方法，各个子类重写了welcome()。

![image-20220324234214932](image/image-20220324234214932.png)
...
![image-20220324235337563](image/image-20220324235337563.png)
...
![image-20220325000034619](image/image-20220325000034619.png)
...
![image-20220503104750655](image/image-20220503104750655.png)
...
![image-20220226101655293](image/image-20220226101655293.png)
...
![image-20220325002959156](image/image-20220325002959156.png)

![image-20220325002932102](image/image-20220325002932102.png)
