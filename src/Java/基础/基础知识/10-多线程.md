...
![image-20220331233204504](image/image-20220331233204504.png)
...
![image-20220514175737426](image/image-20220514175737426.png)
...
![1563267431480](image/1563267431480.png)

3、一个进程中包含多个线程

![1563270525077](image/1563270525077.png)
...
![image-20220401000804242](image/image-20220401000804242.png)

![image-20220513181758585](image/image-20220513181758585.png)

* **并发（concurrency）**：指两个或多个事件在`同一个时间段内`发生。即在一段时间内，有`多条指令`在`单个CPU`上`快速轮换、交替`执行，使得在宏观上具有多个进程同时执行的效果。

![image-20220401000515678](image/image-20220401000515678.png)

![image-20220513181815978](image/image-20220513181815978.png)
...
![image-20220401221215860](image/image-20220401221215860.png)
...
![image-20220401222212377](image/image-20220401222212377.png)
...
![image-20220401002307038](image/image-20220401002307038.png)
...
![image-20220524203355448](image/image-20220524203355448.png)

或

![线程的生命周期Thread.State](image/线程的生命周期Thread.State.jpg)
...
![image-20220524195035355](image/image-20220524195035355.png)
...
![image-20220401233218326](image/image-20220401233218326.png)



类比：

![](image/当我以为我的代码很安全时，等等.gif)
...
![1563372934332](image/1563372934332.png)
...
![thread-lock](image/thread-lock.png)
