...
![image-20231206134408141](image/image-20231206134408141.png)
...
![image-20231206135717328](image/image-20231206135717328.png)
...
![image-20231206135827291](image/image-20231206135827291.png)

自然地，我们就会从“车由什么组成”开始思考。发现，车由如下结构组成：  

![image-20231206135842999](image/image-20231206135842999.png)
...
![image-20231206140007223](image/image-20231206140007223.png)
...
![image-20231206140318809](image/image-20231206140318809.png)

### 1.3 如何掌握这种思想？  

![image-20231206140334380](image/image-20231206140334380.png)
...
![image-20231206140413982](image/image-20231206140413982.png)
...
![image-20231206140641081](image/image-20231206140641081.png)

可以理解为： `类 => 抽象概念的人` ； `对象 => 实实在在的某个人  `

![image-20231206140701371](image/image-20231206140701371.png)

![image-20231206140706834](image/image-20231206140706834.png)
...
![image-20231206140731641](image/image-20231206140731641.png)
...
![image-20231206141523315](image/image-20231206141523315.png)
...
![image-20231206141721499](image/image-20231206141721499.png)

- 举例：  

![image-20231206141737043](image/image-20231206141737043.png)
...
![image-20231206142020880](image/image-20231206142020880.png)
...
![image-20231206142220927](image/image-20231206142220927.png)
...
![image-20231206142931953](image/image-20231206142931953.png)
...
![image-20231206143105042](image/image-20231206143105042.png)
...
![image-20231206143257718](image/image-20231206143257718.png)
...
![image-20231206143647549](image/image-20231206143647549.png)

![image-20231206143656037](image/image-20231206143656037.png)
...
![image-20231206143823913](image/image-20231206143823913.png)
...
![image-20231206143917276](image/image-20231206143917276.png)

## 5.类的成员之二：方法(method)  

### 5.1 方法的引入  

![image-20231206143958710](image/image-20231206143958710.png)
...
![image-20231206152245150](image/image-20231206152245150.png)

**2、类比举例**  

![image-20231206152256594](image/image-20231206152256594.png)
...
![image-20231206153031482](image/image-20231206153031482.png)

### 5.8 练习

**练习1**：创建一个Person类，其定义如下：

![image-20231206153051646](image/image-20231206153051646.png)
...
![image-20231206153646629](image/image-20231206153646629.png)
...
![image-20231206153811107](image/image-20231206153811107.png)
...
在**JDK 5.0** 中提供了**Varargs(variable number of arguments)**机制。即当定义一个方法时，形参的类型可以确定，但是形参的个数不确定，那么可以考虑使用可变个数的形参。格式：
...
![image-20231206162227826](image/image-20231206162227826.png)
...
![image-20231206162241558](image/image-20231206162241558.png)
...
![image-20231206162420679](image/image-20231206162420679.png)

练习4： `貌似是 `考查方法的参数传递  

![image-20231206162437521](image/image-20231206162437521.png)
...
![image-20231206162534863](image/image-20231206162534863.png)

### 7.4 递归(recursion)方法

举例1：

![image-20231206162551618](image/image-20231206162551618.png)
...
![image-20231206163211499](image/image-20231206163211499.png)
...
![image-20231206163241100](image/image-20231206163241100.png)
...
![image-20231206163521197](image/image-20231206163521197.png)
...
![image-20231206163603448](image/image-20231206163603448.png)
...
![image-20231206164040152](image/image-20231206164040152.png)
...
![image-20231206164143468](image/image-20231206164143468.png)
...
![image-20231206165526147](image/image-20231206165526147.png)

![image-20231206165531830](image/image-20231206165531830.png)
...
![image-20231206171325751](image/image-20231206171325751.png)
...
1. 当我们没有显式的声明类中的构造器时，系统会默认提供一个无参的构造器并且该构造器的修饰符默认与类的修饰符相同![image-20231206171657309](image/image-20231206171657309.png)
...
![image-20231206171905801](image/image-20231206171905801.png)

**提示**：在提款方法withdraw中，需要判断用户余额是否能够满足提款数额的要求，如果不能，应给出提示。  

2、创建Customer类。  

![image-20231206171932500](image/image-20231206171932500.png)
...
![image-20231206172607204](image/image-20231206172607204.png)

![image-20231206172615349](image/image-20231206172615349.png)
